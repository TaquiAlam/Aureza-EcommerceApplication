...
public class CategoryServiceimpl implements CategoryService {
    ...
    @Override
    public CategoryResponseDTO getAllCategories(Integer PageNumber, Integer PageSize, String sortbyID,
            String sortAS_DS) {
        Sort sortASCorDSC = sortAS_DS.equalsIgnoreCase("asc") ? Sort.by(sortbyID).ascending()
